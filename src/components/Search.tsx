...
const Search = ({ queryParams, setQueryParams }: { queryParams: QueryParams; setQueryParams: React.Dispatch<React.SetStateAction<QueryParams>> }) => {
  ...
  return (
    <div className="relative flex">
      <input id="search" className="block" placeholder="Search" onChange={(e) => setSearchValue(e.target.value)} value={searchValue} />
      <div className="absolute right-0 top-1/2 w-9 -translate-y-1/2">
