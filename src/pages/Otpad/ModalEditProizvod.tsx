...
const ModalEditProizvod: React.FC<Props> = ({ setShowModalEdit, updateData, setUpdateData, fetchData }) => {
  ...
  const handleSaveOk = async () => {
    ...
    try {
      ...
      toast.success(`Proizvod ${updateData?.proizvod} je uspešno sačuvan!`, {
                    ...
                    <div className="grid grid-cols-1">
                      ...
                      <div>
                        <div className="col-lg-12 mb-3">
                          ...
                          <input value={updateData?.proizvod} type="text" id="proizvod" aria-describedby="Proizvod" required onChange={handleChange} />
                        </div>
                      </div>
                    </div>
                    <div className="my-4 h-0.5 bg-zinc-400"></div>
