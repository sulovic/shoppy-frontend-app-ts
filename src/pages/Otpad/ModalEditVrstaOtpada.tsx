...
const ModalEditVrstaOtpdada: React.FC<Props> = ({ setShowModalEdit, updateData, setUpdateData, fetchData }) => {
  ...
  const handleSaveOk = async () => {
    setShowSpinner(true);
    try {
      await axiosPrivate.put(`otpad/vrste-otpada/${updateData?.id}`, updateData);
      toast.success(`Vrsta otpada ${updateData?.vrstaOtpada} je uspešno sačuvana!`, {
