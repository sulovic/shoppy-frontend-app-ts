...
const ObradaReklamacija: React.FC = () => {
  ...
  return (
    <>
      ...
      {tableData && tableData.length ? <ReklamacijeTable tableData={tableData} fetchData={fetchData} /> : !showSpinner && <h4 className="my-4 text-zinc-600 ">Nema reklamacija koje su u obradi...</h4>}
